...
public class PeliculaService {
    ...
    public PeliculaService() {
        ...
        Pelicula pelicula = new Pelicula(tem, "Oso vicioso", "Elizabeth Banks", "Jimmy Warden",
        ...
        pelicula.setActores(
                new ArrayList<String>(Arrays.asList("Keri Russell", "Alden Ehrenreich", "O'Shea Jackson Jr")));
        pelicula.setGeneros(new ArrayList<String>(Arrays.asList("Comedia", "Suspense")));
        pelicula.setReviews(new ArrayList<String>(Arrays.asList("Me encanta")));
        peliculaHashMap.put(tem, pelicula);

        Pelicula pelicula2 = new Pelicula(null, "John Wick 3", "Chad Stahelski", "Derek Kolstad",
                ...
                7.4);
        pelicula2.setActores(new ArrayList<String>(Arrays.asList("Keanu Reeves", "Halle Berry", "Ian McShane",
        ...
        pelicula2.setReviews(new ArrayList<String>(Arrays.asList("Me encanta")));
        createPelicula(pelicula2);

        Pelicula pelicula3 = new Pelicula(null, "Karate a muerte en Torremolinos", "Pedro Temboury", "Pedro Temboury",
        ...
        pelicula3.setReviews(new ArrayList<String>(Arrays.asList("Me encanta")));
        createPelicula(pelicula3);

        Pelicula pelicula4 = new Pelicula(null, "The Equalizer 2", "Antoine Fuqua", "Richard Wenk",
                ...
                6.7);
        pelicula4.setActores(new ArrayList<String>(Arrays.asList("Denzel Washington", "Pedro Pascal", "Bill Pullman",
                "Melissa Leo", "Ashton Sanders", "Jonathan Scarfe")));
        pelicula4.setGeneros(new ArrayList<String>(Arrays.asList("Accion", "Crimen", "Suspense")));
        pelicula4.setReviews(new ArrayList<String>(Arrays.asList("Me encanta")));
        createPelicula(pelicula4);

        Pelicula pelicula5 = new Pelicula(null, "Resacón en Las Vegas", "Todd Phillips", "Jon Lucas",
                ...
                7.7);
        pelicula5.setActores(new ArrayList<String>(Arrays.asList("Bradley Cooper", "Ed Helms", "Zach Galifianakis",
        ...
        pelicula5.setReviews(new ArrayList<String>(Arrays.asList("Me encanta")));
        createPelicula(pelicula5);

        Pelicula pelicula6 = new Pelicula(null, "AIR", "Ben Affleck", "Alex Convery",
                ...
                7.8);
        pelicula6.setActores(new ArrayList<String>(Arrays.asList("Matt Damon", "Ben Affleck", "Viola Davis",
    ...
    /*public Optional<String> getReviewById(Long peliculaId, Long reviewId) {
        Pelicula pelicula = peliculaHashMap.get(peliculaId);
        if (pelicula != null) {
            List<String> reviews = pelicula.getReviews();
    ...
    /*public boolean deleteReview(Pelicula pelicula, Long reviewId) {
        List<String> reviews = pelicula.getReviews();
        boolean removed = reviews.removeIf(review -> review.equals(reviewId.toString()));
        if (removed) {
            pelicula.setReviews(reviews);
            peliculaHashMap.replace(pelicula.getId(), pelicula);
        }
        return removed;
    }*/
